...
class AppColors {
  static Color scaffoldBackgroundColorDark = const Color(0xff161616);
  ...
  static Color seconderyColor = Colors.blue[200]!;
  static Color seconderyButtonColor = Colors.blueAccent;
